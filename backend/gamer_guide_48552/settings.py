"""
Django settings for gamer_guide_48552 project.
...
ROOT_URLCONF = 'gamer_guide_48552.urls'
...
WSGI_APPLICATION = 'gamer_guide_48552.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Gamer Guide Support <support@gamer-guide-48552.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gamer_guide_48552 API",
    "DESCRIPTION": "API documentation for gamer_guide_48552 App",
    "VERSION": "v1",
}
